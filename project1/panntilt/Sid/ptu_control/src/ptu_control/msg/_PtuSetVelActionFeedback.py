"""autogenerated by genmsg_py from PtuSetVelActionFeedback.msg. Do not edit."""
...
class PtuSetVelActionFeedback(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','ptu_control/PtuSetVelFeedback']

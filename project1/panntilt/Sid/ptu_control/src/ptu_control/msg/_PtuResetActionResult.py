"""autogenerated by genmsg_py from PtuResetActionResult.msg. Do not edit."""
...
class PtuResetActionResult(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','ptu_control/PtuResetResult']

"""autogenerated by genmsg_py from PtuResetActionFeedback.msg. Do not edit."""
...
class PtuResetActionFeedback(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','ptu_control/PtuResetFeedback']

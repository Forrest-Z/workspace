...
namespace BFL
{
  ...
  using namespace MatrixWrapper;
    ...
    // Constructor
    DataAssociationFilterGaussianMurty::DataAssociationFilterGaussianMurty(vector<Filter<ColumnVector,ColumnVector>* > filters, double gamma, double treshold, int maxFilters, int maxFeatures, bool onlyUseCentroidMeasurement)
      :DataAssociationFilterMurty<ColumnVector,ColumnVector>(filters,gamma,treshold,maxFilters,maxFeatures,onlyUseCentroidMeasurement)
    {
#ifndef NDEBUG
        cout<< "DataAssociationFilterGaussianMurty Constructor" << endl;
#endif
...
//    // Copy Constructor
//    DataAssociationFilterGaussianMurty::DataAssociationFilterGaussianMurty(const DataAssociationFilterGaussianMurty& filters)
...
//    }
    ...
    DataAssociationFilterGaussianMurty::~DataAssociationFilterGaussianMurty()
    {}
    

    void
    DataAssociationFilterGaussianMurty::AddFilter(Filter<ColumnVector,ColumnVector>* filter)
    {
#ifndef NDEBUG
        cout << "entered AddFilter" << endl;
#endif
        DataAssociationFilterMurty<ColumnVector,ColumnVector>::AddFilter(filter);
#ifndef NDEBUG
    ...
    bool
    DataAssociationFilterGaussianMurty::RemoveFilter(int index)
    {
        DataAssociationFilterMurty<ColumnVector,ColumnVector>::RemoveFilter(index);
    ...
    DataAssociationFilterGaussianMurty::GetMeasProbs(MeasurementModel<ColumnVector,ColumnVector>* const measmodel , const vector<ColumnVector>& z, const ColumnVector& s)
    {
#ifndef NDEBUG
    ...
    bool
    DataAssociationFilterGaussianMurty::UpdateInternal(SystemModel<ColumnVector>* const sysmodel,
    ...
    {
#ifndef NDEBUG
      cout << "DataAssociationFilterGaussianMurty:: entering update internal" << endl;
#endif
      ...
      if(measmodel!=NULL)
      {
        if(!_variablesUpdateInternalSet)
        {
#ifndef NDEBUG
            cout << "DataAssociationFilterGaussianMurty:: the necessary variables are not set before running measUpdate" << endl;
#endif
            return false;
        }
#ifndef NDEBUG
        cout << "DataAssociationFilterGaussianMurty:: entering meas update" << endl;
        cout << "DataAssociationFilterGaussianMurty:: get association probs" << endl;
#endif
        this->GetAssociationProbs(measmodel , z, s);
        // writes _association_probs
#ifndef NDEBUG
        cout << "DataAssociationFilterGaussianMurty:: got association probs" << endl;
#endif
        ...
        {
#ifndef NDEBUG
           cout << "DataAssociationFilterGaussianMurty:: object " << object << endl;
#endif
           ...
           for (int feature = 0 ; feature<z.size() ; feature ++ )
           {
                ...
                cout << "p(z|x)" << this->_association_probs[feature][object] << endl;
#endif
...
#ifndef NDEBUG
    cout << "DataAssociationFilterGaussianMurty:: leaving update internal" << endl;
#endif
    _measProbsCalculated = false; 
    _variablesUpdateInternalSet = false;
    return return_bool;
    }

    void
    DataAssociationFilterGaussianMurty::AllocateMeasModel(const vector<unsigned int>& meas_dimensions)
    {
    ...
    void
    DataAssociationFilterGaussianMurty::AllocateMeasModel(const unsigned int& meas_dimension)
    {
       // find if variables with size meas_sizes[i] are already allocated
       _mapMeasUpdateVariables_it =  _mapMeasUpdateVariables.find(meas_dimension);
       if( _mapMeasUpdateVariables_it == _mapMeasUpdateVariables.end())

#ifndef __ESTIMATIONMCPDF__
#define __ESTIMATIONMCPDF__
    ...
    *****************/
    ...
    protected:
        ...
        ***********/
        ...
        /// Radius of circular target to calculate priors for clustering
    ...
    public:
        ...
        */
        EstimationMCPdf(std::string name);
        /** 
        * Destructor
        */
        ~EstimationMCPdf();

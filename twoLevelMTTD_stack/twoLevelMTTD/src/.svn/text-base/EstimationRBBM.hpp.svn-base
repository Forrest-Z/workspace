#ifndef __ESTIMATIONRBBM__
#define __ESTIMATIONRBBM__
...
namespace OCL
{
    ...
    *****************/
    ...
    public:
        ...
        */
        EstimationRBBM(std::string name);
        /** 
        * Destructor
        */
        ~EstimationRBBM();

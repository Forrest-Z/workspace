#ifndef __ESTIMATIONRBBM_radius__
#define __ESTIMATIONRBBM_radius__
...
#include <dataAssociationFilterMCPdfMurty.h>
...
namespace OCL
{
    ...
    * reference), for the case bootstrap filters are used for the individual
    * target trackers
    *****************/
    class EstimationRBBM_radius
        : public TaskContext
    {
    ...
    private:
        ...
        DataAssociationFilterMCPdfMurty<ColumnVector,ColumnVector >* _dataAssociationFilterMCPdf;
        ...
        // RBBM Conditional pdf
        RBBMCartesian_radius*                                   _RBBM;
        /// The pdf underlying the measurement model
        LinearAnalyticConditionalGaussian*                      _measPdf;
        /// The measurement model
        MeasurementModel<ColumnVector,ColumnVector>*            _measModel;
    ...
    protected:
        ...
        ***********/
        ...
        /// The maximum number of associations in the data association filter that can be used (for memory allocation)
        Property<int>                   _maxNumberAssociations;
        /// The maximum number of GetAssociations calls (recursive function) in the data association filter that can be used (for memory allocation)
        Property<int>                   _maxNumberAssociationCalls;
        ...
        /// The mean of the prior for a new tracker
        Property<ColumnVector>          _priorMean;
        /// ColumnVector containting the diagonal values of the initial covariances for a new target state : it is assumed that the initial estimates are uncoupled (i.e. the initial covariance matrix is  diagonal) 
        Property<ColumnVector>          _priorCovariance;
        /// The number of prior filters
        Property<int>                   _numPriorFilters;
        /// The mean of the prior of the trackers
        Property<vector<ColumnVector> > _priorMeanFilters;
        ...
        Property<vector<ColumnVector> > _priorCovarianceFilters;
        ...
        /// The covariance of the white noise on the radius system model
        Property<double>                                _sysNoiseCovarianceValueRadius;
        /// The number of samples 
        Property<int>                   _numSamples;
        Property<int>                   _resamplePeriod;
        Property<double>                _resampleThreshold;
        Property<int>                   _resampleScheme;
        Property<double>                                _p;
        Property<double>                                _zmax;
        Property<double>                                _sigma_m;
        Property<double>                                _pi3;
        Property<double>                                _pi4;
        Property<std::string>                           _environment_file;
        Property<int>                                   _nbeams;
        /// only use centroid measurements or not
        Property<bool>                                  _onlyUseCentroidMeasurement;
    ...
    public:
        ...
        */
        EstimationRBBM_radius(std::string name);
        /** 
        * Destructor
        */
        ~EstimationRBBM_radius();
...
#endif // __ESTIMATIONRBBM_radius__

// $Id: RBBMCartesian.cpp 29890 2009-02-02 10:22:01Z tdelaet $
...
//ORO_CREATE_COMPONENT(BFL::RBBMCartesian)

#define NUMCONDARGUMENTS_RBBMCARTESIAN 1
...
namespace BFL
{
  ...
  RBBMCartesian::RBBMCartesian( double p, double zmax, double sigma_m, Probability pi3, Probability pi4, ColumnVector scannerPos, string environment_file, int nbeams, double radiusState)
  ...
  {
#ifndef NDEBUG
    cout << "RBBMCartesian constructor started " << endl;
#endif
    this->NumConditionalArgumentsSet(NUMCONDARGUMENTS_RBBMCARTESIAN);
    ConditionalPdf<ColumnVector,ColumnVector>::NumConditionalArgumentsSet(NUMCONDARGUMENTS_RBBMCARTESIAN);
    ...
    for(int i=0; i<_nbeams;i++) 
    {
        ...
        _beamModels[i]->NumConditionalArgumentsSet(NUMCONDARGUMENTS_RBBMCARTESIAN);
        ((ConditionalPdf<ColumnVector,ColumnVector>*)_beamModels[i])->NumConditionalArgumentsSet(NUMCONDARGUMENTS_RBBMCARTESIAN);
    }   
    ...
    if(!indata)  // file couldn't be opened
        cerr << "(RBBMCartesian) Error: file " << _environment_file << " could not be opened" << endl;
    ...
    { 
     ...
     indata.close();
#ifndef NDEBUG
    cout << "RBBMCartesian constructor finished " << endl;
#endif
  }

  /// Destructor
  RBBMCartesian::~RBBMCartesian()
  {
    //delete _phit, poccl, prand, pmax;
  }

  //Clone function
  RBBMCartesian* RBBMCartesian::Clone() const
  {
      return new RBBMCartesian(*this);
  }

  void RBBMCartesian::CalculateZstars() const
  {
#ifndef NDEBUG
    cout << "(RBBMCartesian::CalculateZstars)  entered " << endl;
#endif
...
//                if( (distsq>pow(_radiusState,2.0)) && (D>=0) &&  ( ( (_relPos(1)*m)>=0) || (i==1 && _relPos(1)>=0) || (i==_nbeams && _relPos(1)<=0)  ) ) 
            ...
            case 2 :
                ...
                break;
            default:
                cerr << "(RBBMCartesian::CalculateZstars) Error no solution found: case wrong implemented " << endl;
        }
  ...
  Probability
  RBBMCartesian::ProbabilityGet(const ColumnVector& meas) const
  {
#ifndef NDEBUG
    cout << "(RBBMCartesian::ProbabilityGet)  entered " << endl;
#endif
    ...
    cout << "(RBBMCartesian::ProbabilityGet)  finished " << endl;
#endif
    return prob;
  }
  ...
  bool
  RBBMCartesian::SampleFrom (vector<Sample<ColumnVector > >& samples, const int num_samples, int method, void * args) const
  {
  ...
  bool
  RBBMCartesian::SampleFrom (Sample<ColumnVector >& sample, int method, void * args) const
  {
        cout << "ERROR: not implemented yet" << endl;
        return false;
  }
  ...
  void
  RBBMCartesian::ConditionalArgumentSet(unsigned int n_argument, const ColumnVector& argument)
  {
#ifndef NDEBUG
    cout << "(RBBMCartesian::ConditionalArgumentSet)  entered " << endl;
#endif
...
#ifndef NDEBUG
    cout << "(RBBMCartesian::ConditionalArgumentSet)  finished " << endl;
#endif
  }

  void
  RBBMCartesian::ConditionalArgumentsSet(std::vector<ColumnVector> condargs)
  {
#ifndef NDEBUG
    cout << "(RBBMCartesian::ConditionalArgumentsSet)  entered " << endl;
#endif
...
#ifndef NDEBUG
   cout << "(RBBMCartesian::ConditionalArgumentsSet)  finished " << endl;
#endif
  }
} // End namespace

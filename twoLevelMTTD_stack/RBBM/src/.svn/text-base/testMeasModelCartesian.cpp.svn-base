...
{
  cerr << "==================================================" << endl
       << "test of RBBMCartesian Meas Model" << endl
       << "==================================================" << endl;
  ...
  RBBMCartesian *rbbm = new RBBMCartesian(p,zmax,sigma_m,pi3,pi4,scannerPos,environment_file,nbeams,radiusState);

...
#ifndef __RBBM_radius
#define __RBBM_radius
...
namespace BFL
{
  /// Non Linear Conditional Pdf for RBBM_radius with unknown radius (Rigorously
  //Bayesian Beam Model )
  /* see: 
  ...
  /** This class inherits only from ConditionalPdf<ColumnVector,
      ColumnVector>.
  */
  class RBBM_radius : public ConditionalPdf<std::vector<MatrixWrapper::ColumnVector>, MatrixWrapper::ColumnVector>
    {
    ...
    public:
      ...
      */
      RBBM_radius( double p, double zmax, double sigma_m, Probability pi3, Probability pi4,ColumnVector scannerPos, string environment_file, int nbeams = 181 );
      ...
      ///Clone function
      virtual RBBM_radius* Clone() const;

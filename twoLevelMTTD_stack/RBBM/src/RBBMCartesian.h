...
#ifndef __RBBMCARTESIAN_
#define __RBBMCARTESIAN_
...
namespace BFL
{
  ...
  /** This class inherits only from ConditionalPdf<ColumnVector,
      ColumnVector>.
  */
  class RBBMCartesian : public ConditionalPdf<MatrixWrapper::ColumnVector, MatrixWrapper::ColumnVector>
    {
    ...
    public:
     ...
     @param radiusState 
      */
      RBBMCartesian( double p, double zmax, double sigma_m, Probability pi3, Probability pi4,ColumnVector scannerPos, string environment_file, int nbeams = 181 , double radiusState = 0.1);

      // Default Copy constructor will do

      /// Destructor
      virtual ~RBBMCartesian();

      ///Clone function
      virtual RBBMCartesian* Clone() const;
